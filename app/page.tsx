  ...
  return (
    <div className="space-y-0">
      ...
      <section className="relative min-h-[85vh] flex items-center overflow-hidden">
        ...
        <div className="absolute inset-0 gradient-editorial"></div>
        ...
        <div className="absolute top-20 right-20 w-64 h-64 bg-mutedRose/10 rounded-full blur-3xl"></div>
        <div className="absolute bottom-40 left-10 w-80 h-80 bg-warmOchre/10 rounded-full blur-3xl"></div>
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-12 py-24">
          <div className="max-w-4xl">
            ...
            >
              ...
              <h1 className="text-6xl lg:text-7xl font-serif font-medium text-deepIndigo mb-8 leading-tight">
                Art-Forward Textiles<br />& Calligraphy
              </h1>
              <p className="text-xl text-softCharcoal leading-relaxed mb-12 max-w-2xl">
              ...
              <div className="flex flex-wrap gap-4">
                <a 
                  href="/collection" 
                  className="group inline-flex items-center gap-3 px-8 py-4 bg-deepIndigo text-ivory hover:bg-indigoDeep transition-all duration-300"
                >
                ...
                <a 
                  href="/events" 
                  className="group inline-flex items-center gap-3 px-8 py-4 border-2 border-deepIndigo text-deepIndigo hover:bg-deepIndigo hover:text-ivory transition-all duration-300"
                >
                  <span className="font-medium tracking-wide">View 2025 Exhibitions</span>
                </a>
              </div>
            </motion.div>
          </div>
      ...
      <section className="relative py-24 bg-warmIvory">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="text-center mb-16">
            ...
            >
              <h2 className="text-5xl font-serif font-medium text-deepIndigo mb-4">
                The Tanja Jacket
              </h2>
              <div className="w-24 h-1 bg-warmOchre mx-auto mb-6"></div>
              <p className="text-lg text-softCharcoal">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <motion.div
              ...
              className="space-y-6"
            >
              <h3 className="text-2xl font-serif text-deepIndigo">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.7 }}
              className="relative bg-cream p-10 border border-warmOchre/20"
            >
              <div className="absolute top-0 left-0 w-20 h-20 border-t-2 border-l-2 border-warmOchre"></div>
              <div className="absolute bottom-0 right-0 w-20 h-20 border-b-2 border-r-2 border-warmOchre"></div>
              
              <h4 className="text-xl font-serif text-deepIndigo mb-6">Where to Find Us</h4>
              <ul className="space-y-4 text-softCharcoal">
              ...
              <a 
                href="/collection" 
                className="inline-flex items-center gap-2 mt-8 px-6 py-3 bg-deepIndigo text-ivory hover:bg-indigoDeep transition-all duration-300"
              >
      ...
      <section className="py-24 bg-warmIvory">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="text-center mb-16">
            <h2 className="text-5xl font-serif font-medium text-deepIndigo mb-6">
              Our Philosophy
            </h2>
            <p className="text-lg text-softCharcoal max-w-3xl mx-auto leading-relaxed">
      ...
      <section className="relative py-24 bg-deepIndigo text-ivory overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-6 lg:px-12 text-center">
          ...
          >
            ...
            <p className="text-warmIvory/80 text-lg mb-12 max-w-2xl mx-auto leading-relaxed">
