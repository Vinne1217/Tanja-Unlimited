...
const CUSTOMER_PORTAL_URL = process.env.SOURCE_DATABASE_URL 
  ? `${process.env.SOURCE_DATABASE_URL}/api/statistics/ai-feedback`
  : 'https://source-database-809785351172.europe-north1.run.app/api/statistics/ai-feedback';
