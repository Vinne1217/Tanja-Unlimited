# Message to Customer Portal Team - Campaign Price Metadata
...
```json
{
  ...
  "amount": 47500,  // ⚠️ REQUIRED: Campaign price in cents (475 SEK)
  "metadata": {     // ⚠️ REQUIRED: Metadata object
    "discount_percent": 5,           // ⚠️ REQUIRED: Discount percentage (5%)
...
- ⚠️ Price shows incorrectly (shows original price instead of discounted price)
